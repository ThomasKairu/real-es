(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_components_43cd6c30._.js", {
...
;
;
function WhatsAppButton({ message = "Hello! I'm interested in your services.", className = "", variant = "fixed" }) {
...
;
;
function ContactForm({ title = "Get In Touch", subtitle = "Ready to start your project? Send us a message!" }) {
    _s();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Email client opened! Please send the email to complete your message.");
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to open email client. Please try again.");
        } finally{
...
_s(ContactForm, "zVBe78issxLVI7wEYaBFTMnyhqU=");
_c = ContactForm;
var _c;
...
//# sourceMappingURL=src_components_43cd6c30._.js.map