        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2 flex-wrap">
            <Input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewExample(prev => ({ ...prev, name: e.target.value }))}
              className="flex-1 min-w-0"
            />
            <Input
              placeholder="Description (optional)"
              value={newExample.description}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewExample(prev => ({ ...prev, description: e.target.value }))}
              className="flex-1 min-w-0"
            />
